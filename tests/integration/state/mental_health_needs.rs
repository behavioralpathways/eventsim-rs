...
use eventsim_rs::{HOPELESSNESS_THRESHOLD, PB_PRESENT_THRESHOLD, TB_PRESENT_THRESHOLD};
...
fn mental_health_compute_suicidal_desire_requires_all_thresholds() {
    ...
    let desire_low_hopelessness = mh_low_hopelessness.compute_suicidal_desire(&high_risk_social);
    assert!(
