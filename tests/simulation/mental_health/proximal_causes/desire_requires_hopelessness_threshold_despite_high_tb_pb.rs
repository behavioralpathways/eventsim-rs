...
fn desire_requires_hopelessness_threshold_despite_high_tb_pb() {
    ...
    let desire_high_tb;
    {
        ...
        tb = high_tb_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        desire_high_tb =
            high_tb_state.get_effective(StatePath::MentalHealth(MentalHealthPath::SuicidalDesire));
    }
    ...
    let desire_no_hopelessness;
    {
        ...
        tb_both = high_tb_pb_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        pb = high_tb_pb_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
        hopelessness = high_tb_pb_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::InterpersonalHopelessness,
        ));
        desire_no_hopelessness = high_tb_pb_state
    ...
    assert!(tb_both > 0.3, "TB should remain elevated, got {}", tb_both);
