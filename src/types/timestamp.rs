...
///
/// ```
/// use eventsim_rs::types::{Timestamp, Duration};
///
/// // Create a timestamp
...
///
/// ```
/// use eventsim_rs::types::{Timestamp, timestamp_to_duration};
///
...
///
/// ```
/// use eventsim_rs::types::{Timestamp, Duration, duration_to_timestamp};
///
/// let start = Timestamp::from_ymd_hms(2024, 1, 1, 0, 0, 0);
