...
fn healthcare_worker_dormant_capability_with_low_desire() {
    ...
    let baseline_risk;
    {
        ...
        baseline_ac = state.get_effective(StatePath::MentalHealth(
    ...
    let risk_experienced;
    {
        ...
        ac_experienced = experienced_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        desire_experienced = experienced_state
            .get_effective(StatePath::MentalHealth(MentalHealthPath::SuicidalDesire));
        risk_experienced =
            experienced_state.get_effective(StatePath::MentalHealth(MentalHealthPath::AttemptRisk));
    }
    ...
    let risk_crisis;
    {
        ...
        ac_crisis = crisis_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        tb_crisis = crisis_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        pb_crisis = crisis_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
        hopelessness_crisis = crisis_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::InterpersonalHopelessness,
        ));
        desire_crisis =
            crisis_state.get_effective(StatePath::MentalHealth(MentalHealthPath::SuicidalDesire));
        risk_crisis =
            crisis_state.get_effective(StatePath::MentalHealth(MentalHealthPath::AttemptRisk));
    }
