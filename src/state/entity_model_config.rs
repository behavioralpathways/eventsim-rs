...
///
/// ```
/// use eventsim_rs::state::EntityModelConfig;
///
/// // Create config for human (personality and mental health enabled)
/// let human_config = EntityModelConfig::human_default();
/// assert!(human_config.mental_health_enabled());
///
/// // Create config for simpler entity
/// let simple_config = EntityModelConfig::new()
///     .with_personality_enabled(true)
///     .with_mental_health_enabled(false);
/// ```
