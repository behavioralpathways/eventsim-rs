...
fn tribal_dynamics_over_ten_years() {
    ...
    // Verify trauma persists 15 years later when the main story begins (2010)
    {
        ...
        let acquired_capability = john_at_story_start.get_effective(StatePath::MentalHealth(
    ...
    let pre_violence_check = story_start + Duration::years(2) - Duration::days(30);
    {
        ...
        let loneliness =
            sue_baseline.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
    ...
    let violence_aftermath = violence_date + Duration::days(1);
    {
        ...
        let acquired_capability = sue_after_violence.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        ...
        assert!(
            stress > 0.0,
            "Violence should spike stress (positive). Got: {}",
            stress
        );
    ...
    let alliance_check = year_3_start + Duration::days(180);
    {
        ...
        let sue_loneliness =
            sue_state.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        ...
        let john_loneliness =
            john_state.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        let john_tb = john_state.get_effective(StatePath::MentalHealth(
    ...
    // Check John's ITS factors (Year 5: 2015)
    {
        ...
        let tb = john_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let pb = john_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
        let ac = john_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        let loneliness =
            john_state.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        ...
        assert!(tb > 0.2, "John's TB should be elevated. Got: {}", tb);
        // PB may be low if self-hate hasn't developed
        println!(
            "  Note: PB = {:.2} (requires both liability AND self-hate)",
            pb
        );
        assert!(
            ac > 0.1,
    ...
    // ------------------------------------------------------------------------
    {
        ...
        let tb = john_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let pb = john_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
        let ac = john_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        let loneliness =
            john_final.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        ...
        println!("  RISK ASSESSMENT: All 3 ITS components elevated = HIGH RISK\n");
        ...
        println!(
            "  Note: John's PB = {:.2} (personality affects attribution)",
            pb
        );
        assert!(
            ac > 0.1,
    ...
    // ------------------------------------------------------------------------
    {
        ...
        let tb = sue_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let pb = sue_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
        let ac = sue_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        let loneliness =
            sue_final.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        ...
        println!("  OUTCOME: Violence increased AC, but support prevented TB/PB\n");

        // Sue should have elevated AC from violence, but low TB due to support
        assert!(ac > 0.0, "Sue should have some AC from violence exposure");
        assert!(
            tb < 0.6,
    ...
    // ------------------------------------------------------------------------
    {
        ...
        let loneliness =
            maria_final.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        let self_worth =
            maria_final.get_effective(StatePath::MentalHealth(MentalHealthPath::SelfWorth));
    ...
    // ------------------------------------------------------------------------
    {
        ...
        let loneliness =
            david_final.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        let valence = david_final.get_effective(StatePath::Mood(MoodPath::Valence));
        let tb = david_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
    ...
    // ------------------------------------------------------------------------
    {
        ...
        let loneliness =
            chen_final.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        let self_hate =
...

    {
        ...
        let ac_before = sue_before.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        let valence_before = sue_before.get_effective(StatePath::Mood(MoodPath::Valence));
        let loneliness_before =
            sue_before.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
        ...
        let ac_current = sue_current.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
...

    {
        ...
        let ac_future = sue_future.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        ...
        let loneliness_future =
            sue_future.get_effective(StatePath::SocialCognition(SocialCognitionPath::Loneliness));
