...
fn chronic_burden_belief_creates_perceived_burdensomeness() {
    ...
    let baseline_pb;
    {
        ...
        baseline_pb = state.get_effective(StatePath::MentalHealth(
    ...
    let pb_liability_only;
    {
        ...
        self_hate_only = liability_only_state
            .get_effective(StatePath::SocialCognition(SocialCognitionPath::SelfHate));
        pb_liability_only = liability_only_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
    }
    ...
    let pb_both;
    {
        ...
        self_hate_both = both_elevated_state
            .get_effective(StatePath::SocialCognition(SocialCognitionPath::SelfHate));
        pb_both = both_elevated_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
    }
