...
///
/// ```
/// use eventsim_rs::entity::{EntityBuilder, EntityBuildError};
///
...
impl EntityBuilder {
    ...
    /// ```
    /// use eventsim_rs::entity::EntityBuilder;
    /// use eventsim_rs::enums::{Species, LifeStage};
    ///
    /// let entity = EntityBuilder::new()
    ///     .species(Species::Human)
    ///     .age(crate::types::Duration::years(30))
    ...
    /// ```
    /// use eventsim_rs::entity::EntityBuilder;
    /// use eventsim_rs::enums::{Species, PersonalityProfile};
    ///
    /// let entity = EntityBuilder::new()
    ///     .species(Species::Human)
    ///     .age(crate::types::Duration::years(30))
    ...
    /// use eventsim_rs::entity::EntityBuilder;
    /// use eventsim_rs::enums::Species;
    /// use eventsim_rs::state::PersonCharacteristics;
    ///
    ...
    /// use eventsim_rs::entity::EntityBuilder;
    /// use eventsim_rs::enums::Species;
    /// use eventsim_rs::state::MentalHealth;
    ///
    ...
    /// use eventsim_rs::entity::EntityBuilder;
    /// use eventsim_rs::enums::Species;
    /// use eventsim_rs::state::SocialCognition;
    ///
    ...
    /// use eventsim_rs::entity::EntityBuilder;
    /// use eventsim_rs::enums::Species;
    /// use eventsim_rs::state::Disposition;
    ///
    ...
    /// use eventsim_rs::entity::EntityBuilder;
    /// use eventsim_rs::enums::Species;
    /// use eventsim_rs::context::{EcologicalContext, Microsystem, WorkContext};
    /// use eventsim_rs::types::MicrosystemId;
    ///
