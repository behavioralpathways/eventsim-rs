...
fn social_isolation_increases_thwarted_belongingness() {
    ...
    // ========================================================================
    {
        ...
        baseline_tb = state.get_effective(StatePath::MentalHealth(
    ...
    // ========================================================================
    {
        ...
        let isolated_loneliness = isolated_state
        ...
        let isolated_tb = isolated_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
