...
fn burden_relief_without_self_hate_reduction_keeps_pb_low() {
    ...
    let pb_elevated;
    {
        ...
        self_hate_elevated = pb_elevated_state
            .get_effective(StatePath::SocialCognition(SocialCognitionPath::SelfHate));
        pb_elevated = pb_elevated_state.get_effective(StatePath::MentalHealth(
    ...
    let pb_post;
    {
        ...
        self_hate_post = post_relief_state
            .get_effective(StatePath::SocialCognition(SocialCognitionPath::SelfHate));
        pb_post = post_relief_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
    }
    ...
    let pb_long_term;
    {
        ...
        self_hate_long_term = long_term_state
            .get_effective(StatePath::SocialCognition(SocialCognitionPath::SelfHate));
        pb_long_term = long_term_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
    }
    ...
    let pb_final;
    {
        ...
        self_hate_final =
            final_state.get_effective(StatePath::SocialCognition(SocialCognitionPath::SelfHate));
        pb_final = final_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
    }
