...
fn social_intervention_reduces_tb_but_not_ac() {
    ...
    let tb_elevated;
    {
        ...
        tb_elevated = isolated_state.get_effective(StatePath::MentalHealth(
    ...
    let ac_pre_intervention;
    {
        ...
        tb_pre_intervention = trauma_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        ac_pre_intervention = trauma_state.get_effective(StatePath::MentalHealth(
    ...
    let ac_post_intervention;
    {
        ...
        tb_post_intervention = post_intervention_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        ac_post_intervention = post_intervention_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
    }
    ...
    let ac_long_term;
    {
        ...
        tb_long_term = long_term_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        ac_long_term = long_term_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
    }
    ...
    let _risk_post_intervention;
    {
        ...
        _desire_post_intervention = risk_test_state
            .get_effective(StatePath::MentalHealth(MentalHealthPath::SuicidalDesire));
        _risk_post_intervention =
            risk_test_state.get_effective(StatePath::MentalHealth(MentalHealthPath::AttemptRisk));
    }
