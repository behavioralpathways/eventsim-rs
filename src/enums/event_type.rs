...
///
/// ```
/// use eventsim_rs::enums::{EventType, EventCategory};
///
...
mod tests {
    ...
    fn tb_events_category_is_social_belonging() {
        assert_eq!(
            EventType::Rejection.category(),
            EventCategory::SocialBelonging
        );
        assert_eq!(
            EventType::SocialIsolation.category(),
            EventCategory::SocialBelonging
        );
        assert_eq!(
            EventType::RelationshipEnd.category(),
            EventCategory::SocialBelonging
        );
        assert_eq!(
            EventType::GroupExclusion.category(),
            EventCategory::SocialBelonging
        );
    }
    ...
    fn pb_events_category_is_burden_perception() {
        assert_eq!(
            EventType::ShamingEvent.category(),
            EventCategory::BurdenPerception
        );
        assert_eq!(
            EventType::FinancialBurden.category(),
            EventCategory::BurdenPerception
        );
        assert_eq!(
            EventType::ChronicIllnessOnset.category(),
            EventCategory::BurdenPerception
        );
        assert_eq!(
            EventType::FamilyDiscord.category(),
            EventCategory::BurdenPerception
        );
    }
    ...
    fn ac_events_category_is_trauma() {
        assert_eq!(
            EventType::NonSuicidalSelfInjury.category(),
            EventCategory::Trauma
        );
        ...
        assert_eq!(
            EventType::ViolenceExposure.category(),
            EventCategory::Trauma
        );
        assert_eq!(
            EventType::PriorSuicideAttempt.category(),
            EventCategory::Trauma
        );
    }
