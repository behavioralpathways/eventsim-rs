...
fn harborlight_resilience_cooperative() {
    ...
    for person in [
        &leah_id, &omar_id, &priya_id, &june_id, &mateo_id, &avery_id,
    ] {
    ...
    // Verify TB reduction after social inclusion
    {
        ...
        let tb_before = mateo_before.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let tb_after = mateo_after.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
    ...
    // Verify arousal buffering after support
    {
        ...
        let arousal_post_support =
            leah_post_support.get_effective(StatePath::Mood(MoodPath::Arousal));

        assert!(
            arousal_post_support < leah_arousal_pre_support,
            "Support should buffer arousal. Before: {}, After: {}",
            leah_arousal_pre_support,
            arousal_post_support
        );
    }
    ...
    let omar_pb_before = {
        ...
        state.get_effective(StatePath::MentalHealth(
    ...
    // Verify role strain increases PB
    {
        ...
        let pb_after = omar_after.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
    ...
    // Verify AC increase and arousal spike at onset
    {
        ...
        let ac_before = omar_before.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        let ac_after = omar_after.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
    ...
    // Verify TB reduction after sustained care
    {
        ...
        let tb_after = mateo_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
    ...
    // Verify caregiver strain increases PB
    {
        ...
        let pb_after = june_after.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
    ...
    // Verify TB increase
    {
        ...
        let tb_after = omar_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
    ...
    // Verify parenting strain increases PB
    {
        ...
        let pb_after = leah_after.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
...

    {
        ...
        let tb_withdrawn = omar_withdrawn.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let tb_final = omar_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
...

    {
        ...
        let valence_complications =
            priya_complications.get_effective(StatePath::Mood(MoodPath::Valence));
        ...
        println!(
            "  Valence during complications (Jan 2026): {:.2}",
            valence_complications
        );
...

    {
        ...
        let stress_overextended =
            june_overextended.get_effective(StatePath::Needs(NeedsPath::Stress));
        let stress_final = june_final.get_effective(StatePath::Needs(NeedsPath::Stress));

        println!("JUNE ALVAREZ (Age 65):");
        println!(
            "  Stress when overextended (Oct 2025): {:.2}",
            stress_overextended
        );
...

    {
        ...
        let tb_baseline = mateo_baseline.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let tb_post_care = mateo_post_care.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let tb_final = mateo_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
    ...
    println!("TB + PB CONVERGENCE (High-Risk Periods):\n");
    {
        ...
        let tb = omar_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let pb = omar_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
        let hopelessness =
            omar_state.get_effective(StatePath::MentalHealth(MentalHealthPath::Hopelessness));
        let interpersonal_hopelessness = omar_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::InterpersonalHopelessness,
        ));
        let suicidal_desire =
            omar_state.get_effective(StatePath::MentalHealth(MentalHealthPath::SuicidalDesire));
...

    {
        ...
        let tb = june_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::ThwartedBelongingness,
        ));
        let pb = june_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::PerceivedBurdensomeness,
        ));
        let hopelessness =
            june_state.get_effective(StatePath::MentalHealth(MentalHealthPath::Hopelessness));
        let interpersonal_hopelessness = june_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::InterpersonalHopelessness,
        ));
...

    {
        ...
        let ac_post_storm = omar_post_storm.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
        let ac_final = omar_final.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
