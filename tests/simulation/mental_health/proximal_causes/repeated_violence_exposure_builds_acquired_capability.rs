...
fn repeated_violence_exposure_builds_acquired_capability() {
    ...
    let post_trauma_ac;
    {
        ...
        post_trauma_ac = post_trauma_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
    }
    ...
    let ac_after_one_year;
    {
        ...
        ac_after_one_year = one_year_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
    }
    ...
    let ac_after_twenty_years;
    {
        ...
        ac_after_twenty_years = twenty_year_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
    }
    ...
    let final_ac;
    {
        ...
        final_ac = final_state.get_effective(StatePath::MentalHealth(
            MentalHealthPath::AcquiredCapability,
        ));
    }
