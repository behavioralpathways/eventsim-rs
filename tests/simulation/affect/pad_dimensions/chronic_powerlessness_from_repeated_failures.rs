...
fn chronic_powerlessness_from_repeated_failures() {
    ...
    let dominance_after_first =
        after_first_state.get_effective(StatePath::Mood(MoodPath::Dominance));
    ...
    let dominance_after_second =
        after_second_state.get_effective(StatePath::Mood(MoodPath::Dominance));
    ...
    let dominance_after_third =
        after_third_state.get_effective(StatePath::Mood(MoodPath::Dominance));
