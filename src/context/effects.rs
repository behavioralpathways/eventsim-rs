...
///
/// ```ignore
/// use eventsim_rs::context::apply_context_effects;
/// use eventsim_rs::state::IndividualState;
/// use eventsim_rs::types::{Duration, Timestamp};
///
/// let state = IndividualState::new();
/// # use eventsim_rs::context::EcologicalContext;
/// let context = EcologicalContext::default();
/// use eventsim_rs::enums::LifeStage;
...
mod tests {
    ...
    fn duration_scales_cumulative_effects() {
        ...
        let state = IndividualState::new();
        let short = apply_context_effects(
            state.clone(),
            &context,
            0.6,
            Duration::days(30),
        ...
        let long = apply_context_effects(
            state,
            &context,
            0.6,
            Duration::days(60),
    ...
    fn proximal_process_gate_scales_microsystem_effects() {
        ...
        let state = IndividualState::new();
        let open = apply_context_effects(
            state,
            &open_context,
            0.6,
            Duration::days(30),
